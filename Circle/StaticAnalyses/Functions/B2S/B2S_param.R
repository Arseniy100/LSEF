...
B2S_param = function(band_V, Omega_nmax, 
  ...
  #-------------------------------------------------------------------------------------------
  # Bands To Spectrum.
  # Fit the following prm mdl to the set of ensm band variances  d:
  # 
  #    b_tofit[n] \approx A* b_shape(n/a)              (*)
  #
  #    Methodology
  #    
  # The two scalar prms, A and a, are required to minimize
  # the misfit of the resulting spectrum to DATA, d (ensm band variances).
  # The obs eqn is
  #  
  #    d = Omega * y + err
  #    
  # The forward mdl is  d_mod = Omega * y.
  # 
