...
CreateExpqBands = function(nmax, nband, halfwidth_min, nc2, halfwidth_max,
  ...
  #namefile=paste0("TranfuExpq_J",nband, "rect", abs(rectang),  "q", q_tranfu,
  #                "sc", nc2, "hwmn", halfwidth_min, "hwmx", halfwidth_max,".png")
  ...
  #namefile=paste0("Re_Resp_Expq_J",nband, "rect", abs(rectang),  "q", q_tranfu,
  #                "sc", nc2, "hwmn", halfwidth_min, "hwmx", halfwidth_max,".png")
  #png(namefile, width=7.48, height=5.47, units = "in", res=300)
  #par(mgp=c(2.5, 1, 0))
  ...
  #namefile=paste0("Im_Resp_Expq_J",nband, "rect", abs(rectang), "q", q_tranfu,
  #                "sc", nc2, "hwmn", halfwidth_min, "hwmx", halfwidth_max,".png")
  #png(namefile, width=7.48, height=5.47, units = "in", res=300)
  #par(mgp=c(2.5, 1, 0))
